...
from panorama.pano_ai.pipeline import CorrectionPipeline, _image, _tensor
...
class CorrectionMethodFactory:
    ...
    def create_overlap_detector(config: Dict, device: str = "cpu"):
        ...
        if use_classical:
            from panorama.pano_classical.overlap_detector_cv import OverlapDetectorCV
            ...
            from panorama.pano_ai.models.advanced_corrections import OverlapDetectionUNet
    ...
    def create_parallax_corrector(config: Dict, device: str = "cpu"):
        ...
        if use_classical:
            from panorama.pano_classical.parallax_correction_cv import ParallaxCorrectionCV
            ...
            from panorama.pano_ai.models.advanced_corrections import ParallaxCorrectionUNet
    ...
    def create_seam_blender(config: Dict, device: str = "cpu"):
        ...
        if use_classical:
            from panorama.pano_classical.seam_blending_cv import SeamBlendingCV
            blend_type = config['classical_parameters']['seam_blending']['blend_type']
            return SeamBlendingCV(blend_type=blend_type)
        else:
            from panorama.pano_ai.models.advanced_corrections import SeamBlendingUNet
    ...
    def create_ghost_remover(config: Dict, device: str = "cpu"):
        ...
        if use_classical:
            from panorama.pano_classical.seam_blending_cv import GhostRemovalCV
            threshold = config['classical_parameters']['ghost_removal']['threshold_ratio']
            return GhostRemovalCV(threshold_ratio=threshold)
        else:
            from panorama.pano_ai.models.advanced_corrections import GhostRemovalUNet
